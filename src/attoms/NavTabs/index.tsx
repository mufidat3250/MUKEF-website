...
const NavTabs = ({tabs,logout, tabIndex, otherStyle, color}:navbarProp) => {
  ...
  return (
   ...
   <div className='tabs'>
     ...
     {
       !logout? <Button title={'Login'} customStyle={'!font-[600] !text-[#0B8EC2] bg-white !rounded-[5px]'}/>
       :  <Button title={'Login Out'} customStyle={`!font-[600] !text-white !bg-[#1D2319] !rounded-[5px]`}/>
     }
     </div>
   </div>
    </div>
