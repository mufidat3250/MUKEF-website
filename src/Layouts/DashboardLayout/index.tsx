        ...
        <section className="">
          ...
          <main className="text-black">
            <div className="mt-[1.375rem] border-[#E7E7E7] border-[1px] rounded-[0.625rem] ml-[4.1875rem] mr-[5.5rem] mb-[3.0625rem]">
              <div className="flex space-x-4 items-center py-[1.125rem] p">
            ...
            {title && (
              <div className="pl-20">
                <p className=" padding-b-[0.5862rem] text-xl font-normal text-[#111111] border-b-[1px] border-[#f5f5f5] mr-[7.6875rem]">
                  {title}
                </p>
              </div>
            )}
