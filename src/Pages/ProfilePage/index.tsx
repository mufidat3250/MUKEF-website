...
const ProfilePage = () => {
  ...
  return (
    <DashboardLayout title="">
      ...
      <p className=" padding-b-[0.5862rem] text-xl font-normal text-[#111111] border-b-[1px] border-[#f5f5f5]">
        ...
        <div className="flex flex-col pb-[2.3206rem]">
          <div className="mb-[5rem]">
            <h1 className="pb-[0.5862rem] border-b-[1px] border-[#F5F5F5] font-normal mb-[2rem] text-[#111111]">Project support history</h1>
            <Table
        ...
        <div className="flex flex-col pb-[1.6331rem]">
          <div className="mb-[5rem]">
          <h1 className="pb-[0.5862rem] border-b-[1px] border-[#F5F5F5] font-normal mb-[2rem] text-[#111111]">Donation history</h1>
            <Table
      ...
      <Modal HeaderText={"Edit profile"} openModal={editModal} closeModal={setEditModal} width='32.75rem'>
            <EditProfile/>
      </Modal>
